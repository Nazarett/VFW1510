...
// in simulator we redefine to format for Nazarett_Gerardo_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.nazarett_gerardo_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nazarett_gerardo_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINazarett_Gerardo_Project1NativeItemNone = -1, 
	UINazarett_Gerardo_Project1NativeItemSpinner = -2,
	UINazarett_Gerardo_Project1NativeItemProgressBar = -3,
	
	UINazarett_Gerardo_Project1NativeItemSlider = -4,
	UINazarett_Gerardo_Project1NativeItemSwitch = -5,
	UINazarett_Gerardo_Project1NativeItemMultiButton = -6,
	UINazarett_Gerardo_Project1NativeItemSegmented = -7,
	
	UINazarett_Gerardo_Project1NativeItemTextView = -8,
	UINazarett_Gerardo_Project1NativeItemTextField = -9,
	UINazarett_Gerardo_Project1NativeItemSearchBar = -10,
	
	UINazarett_Gerardo_Project1NativeItemPicker = -11,
	UINazarett_Gerardo_Project1NativeItemDatePicker = -12,
	
	UINazarett_Gerardo_Project1NativeItemInfoLight = -13,
	UINazarett_Gerardo_Project1NativeItemInfoDark = -14,
	
	UINazarett_Gerardo_Project1NativeItemDisclosure = -15,
	
	UINazarett_Gerardo_Project1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Nazarett_Gerardo_Project1 instances of
