...
//Rare exceptions to indicate a bug in the _nazarett_gerardo_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Nazarett_Gerardo_Project1 proxies.
 */
