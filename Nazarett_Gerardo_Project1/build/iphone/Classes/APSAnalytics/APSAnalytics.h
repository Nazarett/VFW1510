 ...
 * to send analytic data that can be viewed on the Nazarett_Gerardo_Project1 Dashboard.
 *
 * For information on getting started with Nazarett_Gerardo_Project1 Platform Services,
