...
@interface Nazarett_Gerardo_Project1Object : KrollCoverageObject {
#else
@interface Nazarett_Gerardo_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Nazarett_Gerardo_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Nazarett_Gerardo_Project1Object *_nazarett_gerardo_project1;
    KrollObject* console;
	BOOL shutdown;
