...
@interface Nazarett_Gerardo_Project3Object : KrollCoverageObject {
#else
@interface Nazarett_Gerardo_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Nazarett_Gerardo_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Nazarett_Gerardo_Project3Object *_nazarett_gerardo_project3;
    KrollObject* console;
	BOOL shutdown;
