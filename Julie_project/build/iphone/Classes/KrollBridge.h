...
@interface Julie_projectObject : KrollCoverageObject {
#else
@interface Julie_projectObject : KrollObject {
#endif
@private
...
extern NSString * Julie_project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Julie_projectObject *_julie_project;
    KrollObject* console;
	BOOL shutdown;
