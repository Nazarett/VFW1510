...
//@interface Julie_projectObject : NSObject
//@end

@interface Julie_projectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Julie_projectObject class]])
		{
			for (NSString *key in [[(Julie_projectObject*)o modules] allKeys])
			{
