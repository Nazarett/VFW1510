...
/**
 The base class for all Nazarett_Gerardo_Project4 modules
 */
...
/**
 Nazarett_Gerardo_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Nazarett_Gerardo_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Nazarett_Gerardo_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Nazarett_Gerardo_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Nazarett_Gerardo_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
