...
// in simulator we redefine to format for Julie_project Developer console
...
{\
	NSString * exceptionName = [@"org.julie_project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.julie_project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIJulie_projectNativeItemNone = -1, 
	UIJulie_projectNativeItemSpinner = -2,
	UIJulie_projectNativeItemProgressBar = -3,
	
	UIJulie_projectNativeItemSlider = -4,
	UIJulie_projectNativeItemSwitch = -5,
	UIJulie_projectNativeItemMultiButton = -6,
	UIJulie_projectNativeItemSegmented = -7,
	
	UIJulie_projectNativeItemTextView = -8,
	UIJulie_projectNativeItemTextField = -9,
	UIJulie_projectNativeItemSearchBar = -10,
	
	UIJulie_projectNativeItemPicker = -11,
	UIJulie_projectNativeItemDatePicker = -12,
	
	UIJulie_projectNativeItemInfoLight = -13,
	UIJulie_projectNativeItemInfoDark = -14,
	
	UIJulie_projectNativeItemDisclosure = -15,
	
	UIJulie_projectNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Julie_project instances of
