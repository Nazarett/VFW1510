...
/**
 Base class for all Julie_project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Julie_project view hierarchy (such as wrapped iOS UIViews) was touched.
