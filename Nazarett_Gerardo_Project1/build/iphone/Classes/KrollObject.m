...
//@interface Nazarett_Gerardo_Project1Object : NSObject
//@end

@interface Nazarett_Gerardo_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Nazarett_Gerardo_Project1Object class]])
		{
			for (NSString *key in [[(Nazarett_Gerardo_Project1Object*)o modules] allKeys])
			{
