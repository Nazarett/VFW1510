...
/**
 The base class for all Julie_project modules
 */
...
/**
 Julie_project Platform calls this method on startup.
 */
-(void)startup;

/**
 Julie_project Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Julie_project Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Julie_project Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Julie_project Platform calls this method on resume.
 @param sender The sender of the event.
 */
