...
//Rare exceptions to indicate a bug in the _julie_project code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Julie_project proxies.
 */
